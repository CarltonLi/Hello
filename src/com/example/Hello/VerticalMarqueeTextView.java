...
public class VerticalMarqueeTextView extends TextView {
    public static final int SCROLL_WAY_SEQUENCE = 1; // scroll in sequence and stop until the end or been stopped
    public static final int SCROLL_WAY_CIRCLE = 2; // scroll in circle and stop until been stopped
    ...
    private void init() {
        ...
        pixelPerLine = 0;
        setScrollWay(SCROLL_WAY_SEQUENCE);
        startMarquee();
            ...
            activity.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if ((VerticalMarqueeTextView.this).getLineCount() > 0) {
                        ...
                        // additional padding.
                        pixelPerLine = (VerticalMarqueeTextView.this).getLineHeight();
                        pixelCount = pixelPerLine * (VerticalMarqueeTextView.this).getLineCount();
                        isNotDrawn = false;
                    }
                }
            });
